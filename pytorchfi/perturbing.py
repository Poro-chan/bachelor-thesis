...
model = torch.hub.load('pytorch/vision:v0.10.0', 'densenet121', pretrained=True) # densenet121, googlenet, inception_v3, mobilenet_v2, resnet18 (squeezenet1_0, squeezenet1_1) -> excluded
...
while epsilon < 0.55:
    ...
    func.evaluate(testloader, perturbed_model, device)
